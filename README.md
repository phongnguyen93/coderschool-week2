...
**Readmee** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* Just add some UI component and animation

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/wReVvAh.gif' title='Video Walkthrough' width='380' height='700' alt='Video Walkthrough' />
